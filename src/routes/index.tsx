...
import { WormholeIntro } from "@/components/landing/WormholeIntro";
import { TransformationSections } from "@/components/landing/TransformationSections";
...
function LandingPage() {
  ...
  return (
    <>
      {/* The logo, as the way in. Owns a screen and a half, then releases. */}
      <WormholeIntro />
      <CinematicLanding />
    </>
  );
